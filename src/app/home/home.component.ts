...
const defaultParams = {
  api_key: "gEaKjqjtiTY1G3zsnpZnJNnhQIdj4fdDbDHhOARt" // My API Key
};

if (defaultParams.api_key === "DEMO_KEY")
  console.warn(
    "Go to https://api.nasa.gov and get your own API_KEY. It's easy!"
  );

const roversApi = "https://api.nasa.gov/mars-photos/api/v1/rovers";
const photosApi = roverName =>
